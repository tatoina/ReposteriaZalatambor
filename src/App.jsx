...
export default function App() {
  ...
  return <div className="app-shell">
    <header className="topbar">
      <button className="brand" onClick={() => user?.email === 'admin@admin.es' ? setView('admin') : user ? setView('account') : (setCustomerAuthPurpose('account'), setShowCustomerAuth(true))} aria-label="Mi cuenta"><img className="brand-logo" src="/logo-reposteria-zalatambor.png" alt="Reposteria Zalatambor" /></button>
